ChimpKit2 is a simple API wrapper for MailChimp's API version 1.3.

There's sample code in the AppDelegate showing how to call API methods (including listSubscribe).
